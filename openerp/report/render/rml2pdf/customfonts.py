...
CustomTTFonts = [ ('Angsana',"Angsana New", "angsa.ttf", 'normal'),
    ...
    ('Kinnari',"Kinnari", "Kinnari.ttf", 'normal'),
    ('Kinnari',"Kinnari-Bold", "Kinnari-Bold.ttf", 'bold'),
    ('Kinnari',"Kinnari-Italic", "Kinnari-Italic.ttf", 'italic'),
    ('Kinnari',"Kinnari-BoldItalic", "Kinnari-BoldItalic.ttf", 'bolditalic'),
    ...
    ('THSarabun',"THSarabun BoldItalic", "THSarabun BoldItalic.ttf", 'bolditalic'),
    ('TH Niramit',"TH Niramit AS", "TH Niramit AS.ttf", 'normal'),
    ('TH Niramit',"TH Niramit AS Bold", "TH Niramit AS Bold.ttf", 'bold'),
    ('TH Niramit',"TH Niramit AS Italic", "TH Niramit AS Bold.ttf", 'italic'),
    ('TH Niramit',"TH Niramit AS BoldItalic", "TH Niramit AS Bold.ttf", 'bolditalic'),
    ('Helvetica',"DejaVu Sans", "DejaVuSans.ttf", 'normal'),
    ('Helvetica',"DejaVu Sans Bold", "DejaVuSans-Bold.ttf", 'bold'),
    ('Helvetica',"DejaVu Sans Oblique", "DejaVuSans-Oblique.ttf", 'italic'),
    ('Helvetica',"DejaVu Sans BoldOblique", "DejaVuSans-BoldOblique.ttf", 'bolditalic'),
    ('Times',"Liberation Serif", "LiberationSerif-Regular.ttf", 'normal'),
    ...
    ('Courier',"FreeMono Oblique", "FreeMonoOblique.ttf", 'italic'),
    ('Courier',"FreeMono BoldOblique", "FreeMonoBoldOblique.ttf", 'bolditalic'),
        ('Helvetica',"DejaVu Sans", "Kinnari.ttf", 'normal'),
        ('Helvetica',"DejaVu Sans Bold", "Kinnari-Bold.ttf", 'bold'),
        ('Helvetica',"DejaVu Sans Oblique", "Kinnari-Oblique.ttf", 'italic'),
        ('Helvetica',"DejaVu Sans BoldOblique", "Kinnari-BoldOblique.ttf", 'bolditalic'),
]
